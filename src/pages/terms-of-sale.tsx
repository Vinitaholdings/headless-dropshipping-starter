  ...
  return (
    <div className="max-w-2xl mx-auto prose prose-blue">
      ...
      <p>
        ...
        wrong with your order, please let us know by contacting us at support@merchbygoods.com!
      </p>

      <h2>Do you offer refunds?</h2>
      <p>
        Refunds are only offered to customers that receive the wrong items or
        damaged items. If any of these apply, please contact us at support@merchbygoods.com with photos of wrong/damaged items and we&apos;ll
      ...
      <p>
        ...
        that&apos;s the case, please let us know at support@merchbygoods.com within a week after receiving your order. Include your order
